...
public class ConquistaUser {
    ...
    private Long idConquistaUser;

    @NotNull(message = "O código do usuário que realizou a conquista ('cd_usuario') não pode estar vazio.")
    @Schema(description = "Código do usuário associado à conquista.", example = "1")
    @Field(name = "cd_usuario")
    private Long cdUsuario;

    @NotNull(message = "O código da conquista realizada ('cd_conquista') não pode estar vazio.")
